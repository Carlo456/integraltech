...
} elseif ($tipoUsuario == 'Provedor' || $tipoUsuario == 'admin') {
      ...
      <tbody>
              ...
              <?php foreach($resultado as $producto) {  ?>    
                                <tr>
                                  ...
                                  <td class="table-light">
                                  <small><strong>Color: </strong>Color:
                                  ...
                                  <small><strong>Procesador: </strong>
                                      ...
                                      <small>
                                      <br>
                                      <strong>Tarjeta gráfica: </strong> <?php echo "{$producto['tarjeta_grafica']}"; ?> <!-- Fecha de peticion  -->
                                      </small>
                                      <small>
                                      <br><br>
                                  ...
                                  <td>
                                  <small> <strong>Cant. pendiente: </strong>
                                        <?php echo "{$producto['cantidad_pend']}"; ?> <!-- numero de la peticion -->
                                        </small>
                                  </td>
                                  <td>
                                  <small><strong>Cant. dañada: </strong>
                                        <?php echo "{$producto['cantidad_daniada']}"; ?> <!-- numero de la peticion -->
                                        </small>
                                  </td>
                                  <td><small><strong>Prod. disponibles: </strong>
                                <?php 
