...
try {
        ...
        $datosProductoUser= "UPDATE modal_venta SET producto='{$producto}', caracteristicas='{$caracteristicas}', info_adicional='{$info_adicional}', cfdi='{$cfdi}', metodo_pago='{$metodo_pago}' WHERE id_cliente='{$id}' AND id_venta='{$id_producto}'";
